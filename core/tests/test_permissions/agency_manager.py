"""Tests related to Agency Manager user permissions."""
import tempfile
...
class AgencyManagerTests(APITestCase):
    """Tests related to the Agency Manager role."""
    ...
    def setUp(self):
        ...
        self.agency.assign_agency_manager(self.user)
    ...
    def test_get_managers(self):
        """Agency Manager can't get a list of Managers."""
    ...
    def test_assign_manager(self):
        """Agency Manager can't assign User as a Manager for the Job."""
        client = f.create_client()
        job = f.create_job(client)
    ...
    def test_remove_from_job_manager(self):
        """Agency Manager can't remove User from Job Managers."""
        client = f.create_client()
        job = f.create_job(client)
        hm = f.create_hiring_manager(client)
    ...
    def test_invite_manager(self):
        """Agency Manager can't invite Hiring Manager."""
    ...
    def test_get_clients(self):
        """Agency Manager can get the list of Clients."""
        f.create_client()
    ...
    def test_create_client(self):
        """Agency Manager can create a Client."""
    ...
    def test_get_client(self):
        """Agency Manager can get the Client details."""
        client = f.create_client()
        f.create_contract(self.agency, client)
    ...
    def test_get_client_without_contract(self):
        """Agency Manager can't get Client details if there's no Contract."""
        client = f.create_client()
    ...
    def test_update_client(self):
        """Agency Manager can't update the Client."""
    ...
    def test_partial_update_client(self):
        """Agency Manager can't partially update the Client."""
        client = f.create_client(name='Test client')
    ...
    def test_partial_update_own_client(self):
        """Agency Manager can partially update their own Client"""
        client = f.create_client()
    ...
    def test_delete_client(self):
        """Agency Manager can't delete the Client."""
        client = f.create_client(name='Test client')
    ...
    def test_create_client_registration_request(self):
        """Agency Manager can create a Client registration request."""
        data = {
            'name': 'Test client',
            'user': {
                'firstName': 'John',
    ...
    def test_create_agency_registration_request(self):
        """Agency Manager can create an Agency registration request."""
        data = {
            'name': 'Test agency',
            'user': {
                'firstName': 'John',
    ...
    def test_get_jobs(self):
        """Agency Manager can get only these Jobs his Agency assigned to."""
        client = f.create_client()
        f.create_job(client)
    ...
    def test_get_jobs_unpublished(self):
        """Agency Manager can get only published Jobs."""
        client = f.create_client()
    ...
    def test_get_public_job(self):
        """Agency Manager can get public Job details."""
    ...
    def test_get_job_agency_assigned(self):
        """Agency Manager can get the Job his Agency assigned to."""
    ...
    def test_get_job_not_assigned(self):
        """Agency Manager can't get the Job his Agency not assigned to."""
    ...
    def test_get_job_unpublished(self):
        """Agency Manager can't get the unpublished Job."""
    ...
    def test_update_job_assigned(self):
        """Agency Manager can't update the Job his Agency assigned to."""
        job = self.create_assigned_job()
        data = {
            'title': 'New title',
        ...
        self.assert_response.no_permission('put', 'job-detail', job.pk, data)

    def test_update_job_not_assigned(self):
        """Agency Manager can't update the Job his Agency not assigned to."""
        job = f.create_job(f.create_client())
    ...
    def test_partial_update_job_assigned(self):
        """Agency Manager can't patch the Job his Agency assigned to."""
        job = self.create_assigned_job()
    ...
    def test_partial_update_job_not_assigned(self):
        """Agency Manager can't patch the Job his Agency not assigned to."""
        job = f.create_job(f.create_client())
    ...
    def test_delete_job_assigned(self):
        """Agency Manager can't delete the Job his Agency assigned to."""
        job = self.create_assigned_job()

        self.assert_response.no_permission('delete', 'job-detail', job.pk)

    def test_delete_job_not_assigned(self):
        """Agency Manager can't delete the Job his Agency not assigned to."""
        job = f.create_job(f.create_client())
    ...
    def test_delete_own_job_file(self):
        """Agency Manager can delete Own Job file.."""
    ...
    def test_get_job_file_not_assigned(self):
        """Agency Manager can't create Job file if not assigned."""
        job = f.create_job(f.create_client())
    ...
    def test_get_job_file_assigned(self):
        """Agency Manager can't create Job file if Agency assigned."""
        job = f.get_job_assigned_to_agency(self.agency,)
    ...
    def test_create_assigned_client_job_file(self):
        """Agency Manager can't create Job file for assigned client's job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_create_job_file_not_assigned_client_job_file(self):
        """Agency manager can't create Job file if not assigned."""
        job = f.create_job(f.create_client())
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_create_job_file_agency_job(self):
        """Agency manager can create Job file if job belongs to agency."""
        job = f.create_job(self.agency)
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_create_job_file_agency_assigned(self):
        """Agency manager can't create Job file if Agency assigned."""
        job = f.get_job_assigned_to_agency(self.agency)
    ...
    def test_delete_job_file(self):
        """Agency Manager can't delete Job file.."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
    ...
    def test_assign_member_own_job(self):
        """Agency manager should be able to assign staff member to a agency own job"""
        job = f.create_job(self.agency)
    ...
    def test_assign_member_client_assigned_job(self):
        """Agency manager should be able to assign staff member to a client's job, if agency is assigned"""
        job = self.create_assigned_job()
    ...
    def test_assign_member_client_job(self):
        """Agency manager shouldn't be able to assign staff member to client's job, if agency is not assigned"""
        job = f.create_job(f.create_client())
    ...
    def test_assign_member_client_job_contract_expired(self):
        """Agency manager shouldn't be able to assign staff member to client's job, if contract is expired"""
    ...
    def test_withdraw_member_client_assigned_job(self):
        """Agency manager should be able to withdraw assigned staff member to a client's job, if agency is assigned"""
        job = self.create_assigned_job()
    ...
    def test_withdraw_member_client_job(self):
        """Agency manager shouldn't be able to withdraw assigned staff member to client's job, if agency is not assigned"""
        job = f.create_job(f.create_client())
    ...
    def test_get_agencies(self):
        """Agency Manager can get the list of Agencies."""
        f.create_agency()
    ...
    def test_create_agency(self):
        """Agency Manager can't create an Agency."""
    ...
    def test_get_agency_own(self):
        """Agency Manager can get his own Agency details."""
    ...
    def test_get_agency_other(self):
        """Agency Manager can't get other Agency details."""
    ...
    def test_update_agency_own(self):
        """Agency Manager can update own Agency."""
    ...
    def test_update_agency_other(self):
        """Agency Manager can't update other Agency."""
    ...
    def test_partial_update_agency_own(self):
        """Agency Manager can patch own Agency."""
        data = {'name': 'New agency'}
        url = reverse('agency-detail', kwargs={'pk': self.agency.pk})
        response = self.client.patch(url, data, format='json')
    ...
    def test_partial_update_agency_other(self):
        """Agency Manager can't patch other Agency."""
        agency = f.create_agency(name='Other agency')
        data = {'name': 'New agency'}
        url = reverse('agency-detail', kwargs={'pk': agency.pk})
        response = self.client.patch(url, data, format='json')
    ...
    def test_delete_agency_own(self):
        """Agency Manager can't delete own Agency."""
        url = reverse('agency-detail', kwargs={'pk': self.agency.pk})
        response = self.client.delete(url)
    ...
    def test_delete_agency_other(self):
        """Agency Manager can't delete other Agency."""
        agency = f.create_agency(name='Other agency')
        url = reverse('agency-detail', kwargs={'pk': agency.pk})
        response = self.client.delete(url)
    ...
    def test_get_agency_staff(self):
        """Agency Manager can access the Staff detail."""
        recruiter = f.create_recruiter(self.agency)
    ...
    def test_get_agency_staff_other_team(self):
        """Agency Manager can access the Staff detail from other team."""
        recruiter = f.create_recruiter(self.agency)
    ...
    def test_get_agency_staff_other_agency(self):
        """Agency Manager can't access the Staff from other Agency."""
    ...
    def test_update_agency_staff(self):
        """Agency Manager can update the Staff."""
    ...
    def test_update_agency_staff_manager(self):
        """Agency Manager can't update other Agency Manager."""
        data = {'is_active': False, 'teams': []}
        am = f.create_agency_manager(self.agency)
        url = reverse('staff-detail', kwargs={'pk': am.pk})
        response = self.client.put(url, data, format='json')

        self.assertEqual(response.status_code, 403)

    def test_update_agency_staff_admin(self):
        """Agency Manager can update the Agency Admin."""
        data = {'is_active': False, 'teams': []}
        aa = f.create_agency_administrator(self.agency)
        url = reverse('staff-detail', kwargs={'pk': aa.pk})
        response = self.client.put(url, data, format='json')

        self.assertEqual(response.status_code, 403)

    def test_update_agency_staff_other_team(self):
        """Agency Manager can update the Staff from other team."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(self.agency)
        recruiter.profile.teams.set([f.create_team(self.agency)])
        recruiter.save()
    ...
    def test_update_agency_staff_other_agency(self):
        """Agency Manager can't update the Staff from other Agency."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(f.create_agency())
    ...
    def test_patch_agency_staff(self):
        """Agency Manager can patch the Staff."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(self.agency)
        url = reverse('staff-detail', kwargs={'pk': recruiter.pk})
        response = self.client.patch(url, data, format='json')
    ...
    def test_patch_agency_staff_other_team(self):
        """Agency Manager can patch the Staff from other team."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(self.agency)
        recruiter.profile.teams.set([f.create_team(self.agency)])
        recruiter.save()
    ...
    def test_patch_agency_staff_manager(self):
        """Agency Manager can't patch other Agency Manager."""
        data = {'is_active': False, 'teams': []}
        am = f.create_agency_manager(self.agency)
        url = reverse('staff-detail', kwargs={'pk': am.pk})
        response = self.client.patch(url, data, format='json')
    ...
    def test_patch_agency_staff_admin(self):
        """Agency Manager can patch the Agency Admin."""
        data = {'is_active': False, 'teams': []}
        aa = f.create_agency_administrator(self.agency)
        url = reverse('staff-detail', kwargs={'pk': aa.pk})
        response = self.client.patch(url, data, format='json')
    ...
    def test_patch_agency_staff_other_agency(self):
        """Agency Manager can't patch the Staff from other Agency."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(f.create_agency())
    ...
    def test_get_agency_teams(self):
        """Agency Manager can get the list of Teams."""
    ...
    def test_get_candidates(self):
        """Agency Manager can get Candidates only from his own Agency."""
    ...
    def test_create_candidate(self):
        """Agency Manager can create a Candidate."""
        data = {
    ...
    def test_get_candidate_own_agency(self):
        """Agency Manager can get the Candidate of his own Agency."""
        candidate = f.create_candidate(self.agency)
    ...
    def test_get_candidate_other_agency(self):
        """Agency Manager can't get the Candidate of the other Agency."""
    ...
    def test_update_candidate_own_agency(self):
        """Agency Manager can update the Candidate of his own Agency."""
    ...
    def test_update_candidate_other_agency(self):
        """Agency Manager can't update the Candidate of the other Agency."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_partial_update_candidate_own_agency(self):
        """Agency Manager can patch the Candidate of his own Agency."""
        candidate = f.create_candidate(
            self.agency,
            first_name='Test',
            last_name='name',
    ...
    def test_partial_update_candidate_other_agency(self):
        """Agency Manager can't patch the Candidate of the other Agency."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_delete_candidate_own_agency(self):
        """Agency Manager can delete the Candidate from his own Agency."""
        candidate = f.create_candidate(self.agency)
    ...
    def test_delete_candidate_other_agency(self):
        """Agency Manager can't delete the Candidate from the other Agency."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_upload_file_own_candidate(self):
        """Agency Manager can upload Candidate file for own Candidate."""
        candidate = f.create_candidate(self.agency)
    ...
    def test_upload_file_other_candidate(self):
        """Agency Manager can't upload Candidate file for other Candidate."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_delete_file_own_candidate(self):
        """Agency Manager can delete Candidate file for own Candidate."""
        candidate = f.create_candidate(self.agency)
        candidate.photo = SimpleUploadedFile('file.txt', b'')
        candidate.save()
    ...
    def test_delete_file_other_candidate(self):
        """Agency Manager can't delete Candidate file for other Candidate."""
        candidate = f.create_candidate(f.create_agency())
        candidate.photo = SimpleUploadedFile('file.txt', b'')
        candidate.save()
    ...
    def test_get_candidate(self, get_zoho_candidate_mock):
        """Agency Manager can get Zoho Candidate."""
    ...
    def test_get_proposals(self):
        """Agency Manager can get Proposals linked to his own Agency only."""
        job = f.create_job(f.create_client())
        agency = f.create_agency()
        f.create_proposal(
            job, f.create_candidate(agency), f.create_agency_manager(agency)
        )
    ...
    def test_create_proposal_own_agency_assigned_job(self):
        """Agency Manager can create Proposal: own Candidate, assigned Job."""
        data = {
    ...
    def test_create_proposal_own_agency_not_assigned_job(self):
        """Agency Manager can't create Proposal: own Cand, not assigned Job."""
        self.assert_response.no_permission(
            'post',
            'proposal-list',
            data={
    ...
    def test_create_proposal_agency_own_job(self):
        """Agency Manager can create Proposal: own Candidate, own Job."""
        data = {
    ...
    def test_create_proposal_other_agency_assigned_job(self):
        """Agency Manager can't create Proposal: other Cand, assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_create_proposal_other_agency_not_assigned_job(self):
        """Agency Manager can't create Proposal: o. Cand not assigned Job."""
        job = f.create_job(f.create_client())
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_get_proposal_own_agency(self):
        """Agency Manager can get Proposal linked to his own Agency."""
    ...
    def test_get_proposal_other_agency(self):
        """Agency Manager can't get Proposal linked to other Agency."""
        proposal = f.create_proposal(
    ...
    def test_update_proposal_own_agency_assigned_job(self):
        """Agency Manager can't update own Agency Prop with assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(self.agency)
        proposal = f.create_proposal(job, candidate, self.user)
    ...
    def test_update_proposal_own_agency_not_assigned_job(self):
        """Agency Manager can't update own Agency Proposal not assigned Job."""
        job = f.create_job(f.create_client())
        candidate = f.create_candidate(self.agency)
        proposal = f.create_proposal(job, candidate, self.user)
    ...
    def test_update_proposal_other_agency_assigned_job(self):
        """Agency Manager can't update other Agency Proposal assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(f.create_agency())
        proposal = f.create_proposal(job, candidate, self.user)
    ...
    def test_update_proposal_other_agency_not_assigned_job(self):
        """Agency Manager can't upd other Agency Proposal not assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(f.create_agency())
        proposal = f.create_proposal(job, candidate, self.user)
    ...
    def test_partial_update_proposal_own_agency_assigned_job(self):
        """Agency Manager can't patch own Agency Proposal with assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        proposal = f.create_proposal(job, f.create_candidate(self.agency), self.user)
    ...
    def test_partial_update_proposal_own_agency_not_assigned_job(self):
        """Agency Manager can't patch own Agency Proposal not assigned Job."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()), f.create_candidate(self.agency), self.user,
        )
    ...
    def test_partial_update_proposal_other_agency_assigned_job(self):
        """Agency Manager can't patch other Agency Proposal assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        proposal = f.create_proposal(
    ...
    def test_partial_update_proposal_other_agency_not_assigned_job(self):
        """Agency Manager can't patch other Agency Prop, not assigned Job."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()),
            f.create_candidate(f.create_agency()),
            self.user,
    ...
    def test_delete_proposal_own_agency_assigned_job(self):
        """Agency Manager can't delete own Agency Proposal assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        proposal = f.create_proposal(job, f.create_candidate(self.agency), self.user)
    ...
    def test_delete_proposal_own_agency_not_assigned_job(self):
        """Agency Manager can't delete own Agency Proposal not assigned Job."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()), f.create_candidate(self.agency), self.user,
        )
    ...
    def test_delete_proposal_other_agency_assigned_job(self):
        """Agency Manager can't delete other Agency Proposal assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        proposal = f.create_proposal(
            job, f.create_candidate(f.create_agency()), self.user
    ...
    def test_delete_proposal_other_agency_not_assigned_job(self):
        """Agency Manager can't delete other Agency Prop, not assigned Job."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()),
            f.create_candidate(f.create_agency()),
            self.user,
    ...
    def test_get_proposal_comments(self):
        """Agency Manager can get the list of Proposal comments."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()), f.create_candidate(self.agency), self.user,
        )
    ...
    def test_create_proposal_comment_own_proposal(self):
        """Agency Manager can create Proposal Comment for own Proposal."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()), f.create_candidate(self.agency), self.user,
        )
    ...
    def test_create_proposal_comment_own_agency_proposal(self):
        """Agency Manager can create Comment for Proposal from own Agency."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()),
    ...
    def test_create_proposal_comment_other_proposal(self):
        """Agency Manager can't create Comment for other Agency's Proposal."""
    ...
    def test_get_proposal_comment_own(self):
        """Agency Manager can get own Proposal Comment details."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()), f.create_candidate(self.agency), self.user,
        )
        comment = f.create_proposal_comment(self.user, proposal)
    ...
    def test_get_proposal_comment_user_own_agency(self):
        """Agency Manager can get own Agency User's Proposal Comment."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()), f.create_candidate(self.agency), self.user,
        )
        recruiter = f.create_recruiter(self.agency)
    ...
    def test_get_proposal_comment_other_agency(self):
        """Agency Manager can't get Proposal Comment of other Agency."""
    ...
    def test_get_proposal_comment_other_agency_public(self):
        """Agency Manager can't get public Comment of other Agency."""
        agency_other = f.create_agency()
        recruiter = f.create_recruiter(agency_other)
    ...
    def test_get_proposal_comment_client(self):
        """Agency Manager can't get Client's Proposal Comment."""
        client = f.create_client()
    ...
    def test_get_proposal_comment_client_public(self):
        """Agency Manager can get Client's public Proposal Comment."""
        client = f.create_client()
        client_admin = f.create_client_administrator(client)
    ...
    def test_mark_all_as_read(self):
        """Agency Manager User can mark all Notifications as read."""
    ...
    def test_mark_as_read(self):
        """Agency Manager User can mark own Notification as read."""
    ...
    def test_mark_as_read_other_user(self):
        """Agency Manager User can't mark other User Notification as read."""
        notification = f.create_notification(
            f.create_user(),
            verb=m.NotificationTypeEnum.CLIENT_CREATED_CONTRACT,
            actor=f.create_agency(),
    ...
    def test_get_conracts(self):
        """Agency Manager can get Contracts linked to his own Agency only."""
        client = f.create_client()
    ...
    def test_create_contract_own_agency(self):
        """Agency Manager can't create a Contract for his own Agency."""
    ...
    def test_create_contract_other_agency(self):
        """Agency Manager can't create a Contract for the other Agency."""
    ...
    def test_get_contract_own_agency(self):
        """Agency Manager can get Contract linked to his own Agency."""
    ...
    def test_get_contract_other_agency(self):
        """Agency Manager can't get Contract linked to other Agency."""
    ...
    def test_update_contract_own_agency(self):
        """Agency Manager can't update the Contract of his own Agency."""
        contract = f.create_contract(self.agency, f.create_client())
    ...
    def test_update_contract_other_agency(self):
        """Agency Manager can't update the Contract of the other Agency."""
        agency = f.create_agency()
    ...
    def test_partial_update_contract_own_agency(self):
        """Agency Manager can't patch the Contract of his own Agency."""
        contract = f.create_contract(self.agency, f.create_client())
    ...
    def test_partial_update_contract_other_agency(self):
        """Agency Manager can't patch the Contract of the other Agency."""
        agency = f.create_agency()
        contract = f.create_contract(agency, f.create_client())
    ...
    def test_delete_contract_own_agency(self):
        """Agency Manager can't delete the Contract of his own Agency."""
        contract = f.create_contract(self.agency, f.create_client())
    ...
    def test_delete_contract_other_agency(self):
        """Agency Manager can't delete the Contract of the other Agency."""
        contract = f.create_contract(f.create_agency(), f.create_client())
    ...
    def test_get_user(self):
        """Agency Manager can get his own User detail."""
    ...
    def test_change_password(self):
        """Agency Manager can update his own User password."""
        data = {
    ...
    def test_confirm_password_reset(self):
        """Agency Manager can confirm password reset with the correct token."""
    ...
    def test_login(self):
        """Agency Manager can log into another account."""
        other_user = f.create_agency_manager(
    ...
    def test_reset_password(self):
        """Agency Manager can request a password reset."""
    ...
    def test_update_settings(self):
        """Agency Manager can update hist own User settings."""
    ...
    def test_get_deal_pipeline_metrics(self):
        """Agency Manager has access to the deal pipeline metrics"""
    ...
    def test_job_import_longlist(self, import_longlist_mock):
        """Agency Manager can import longlist"""
        job = f.create_job(self.agency)
        data = {
            'from_job': job.pk,
            'candidates': [],
