"""Tests related to Recruiter user permissions."""
import tempfile
...
class RecruiterTests(APITestCase):
    """Tests related to the Recruiter role."""
    ...
    def create_assigned_job(self, client=None):
        is_contract_exists = False
        if client is None:
            client = f.create_client()
        else:
            is_contract_exists = self.agency.contracts.filter(client=client).exists()
    ...
    def test_get_managers(self):
        """Recruiter can't get a list of Managers."""
    ...
    def test_assign_manager(self):
        """Recruiter can't assign User as a Manager for the Job."""
        client = f.create_client()
        job = f.create_job(client)
    ...
    def test_remove_from_job_manager(self):
        """Recruiter can't remove User from Job Managers."""
        client = f.create_client()
        job = f.create_job(client)
        hm = f.create_hiring_manager(client)
    ...
    def test_invite_manager(self):
        """Recruiter can't invite Hiring Manager."""
    ...
    def test_get_clients(self):
        """Recruiter can get the list of Clients."""
        f.create_client()
    ...
    def test_get_client(self):
        """Recruiter can get the Client details."""
        client = f.create_client()
        f.create_contract(self.agency, client)
    ...
    def test_get_client_without_contract(self):
        """Recruiter can't get the Client details if there's no Contract."""
        client = f.create_client()
    ...
    def test_update_client(self):
        """Recruiter can't update the Client."""
    ...
    def test_partial_update_own_client(self):
        """Recruiter can partially update their own Client"""
        client = f.create_client()
    ...
    def test_partial_update_client(self):
        """Recruiter can't partially update the Client."""
        client = f.create_client(name='Test client')
    ...
    def test_partial_update_own_client(self):
        """Agency Recruiter can partially update their own Client"""
        client = f.create_client()
        client.owner_agency = self.agency
        client.save()
    ...
    def test_delete_client(self):
        """Recruiter can't delete the Client."""
        client = f.create_client(name='Test client')
    ...
    def test_create_client_registration_request(self):
        """Recruiter can create a Client registration request."""
        data = {
            'name': 'Test client',
            'user': {
                'firstName': 'John',
    ...
    def test_create_agency_registration_request(self):
        """Recruiter can create an Agency registration request."""
        data = {
            'name': 'Test agency',
            'user': {
                'firstName': 'John',
    ...
    def create_job_with_expired_contract(self, should_assign_member=True):
    ...
    def test_get_jobs_unpublished(self):
        """Recruiter can get only published Jobs."""
        client = f.create_client()
        j1 = f.get_job_assigned_to_agency(self.agency, client)
        j1.assign_member(self.user)

        unpublished_job = f.get_job_assigned_to_agency(
            self.agency, client, job_data={'published': False}
        )
    ...
    def test_create_job(self):
        ...
        data = self.get_create_job_data(
            owner_id=owner.id, client_id=f.create_client(owner_agency=self.agency).id,
        )
        ...
        # owner agency is automatically assigned to a job
    ...
    def test_get_public_job(self):
        """Assignee can get public Job details."""
    ...
    def test_get_job_agency_and_members_assigned(self):
        """Assignee can get the Job he and his Agency was assigned to."""
        client = f.create_client()
        job = f.create_job(client)
        job.assign_agency(self.agency)
        job.assign_member(self.user)
        f.create_contract(self.agency, client, status=m.ContractStatus.INITIATED.key)
    ...
    def test_get_job_agency_assigned(self):
        """Assignee can't get the Job his Agency assigned to but he is not"""
    ...
    def test_get_job_recruiter_assigned(self):
        """Recruiter can't get the Job he was assigned to, but not his Agency."""
        client = f.create_client()
        job = f.create_job(client)
        job.assign_member(self.user)
        f.create_contract(self.agency, client, status=m.ContractStatus.INITIATED.key)
    ...
    def test_get_job_not_assigned(self):
        """Recruiter can't get the Job his Agency not assigned to."""
    ...
    def test_get_job_unpublished(self):
        """Recruiter can't get the unpublished Job."""
    ...
    def test_update_job_assigned(self):
        """Recruiter can't update the Job his Agency assigned to."""
        job = self.create_assigned_job()
        ...
        self.assert_response.not_found('patch', 'job-detail', job.pk, data)

    def test_update_job_not_assigned(self):
        """Recruiter can't update the Job his Agency not assigned to."""
        job = f.create_job(f.create_client())
    ...
    def test_partial_update_job_assigned(self):
        """Recruiter can't patch the Job his Agency assigned to."""
        job = self.create_assigned_job()
    ...
    def test_partial_update_job_not_assigned(self):
        """Recruiter can't patch the Job his Agency not assigned to."""
        job = f.create_job(f.create_client())
    ...
    def test_delete_job_assigned(self):
        """Recruiter can't delete the Job his Agency assigned to."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
    ...
    def test_delete_job_not_assigned(self):
        """Recruiter can't delete the Job his Agency not assigned to."""
        job = f.create_job(f.create_client())
    ...
    def test_partial_update_reopen_job_not_assigned(self):
        """Recruiter shouldn't be able to reopen the job he is not assigned to"""
    ...
    def test_partial_update_reopen_job_not_assigned_owner(self):
        """Recruiter shouldn't be able to reopen the job he is not assigned to"""
        job = self.fill_job(f.create_job(self.agency, owner=self.user))
    ...
    def test_partial_update_reopen_job_not_enough_openings(self):
        ...
        errors.add_field_error('status', 'no_permission_to_open')
    ...
    def test_create_job_file(self):
        """Agency Member can't create Job file for client's job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        job.assign_member(self.user)
    ...
    def test_create_own_not_assigned_job_file(self):
        """Recruiter can't create Job file if not assigned to job."""
    ...
    def test_create_own_assigned_job_file(self):
        """Recruiter can create Job file if assigned to job."""
        job = f.create_job(self.agency)
        job.assign_member(self.user)
    ...
    def test_get_job_file_not_assigned(self):
        """Recruiter can't get Job file if not assigned to a Job."""
        job = f.create_job(f.create_client())
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_get_job_file_member_and_agency_assigned(self):
        """Agency Member can get Job file if assigned to a Job."""
        job = f.get_job_assigned_to_agency(self.agency)
        job.assign_member(self.user)
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_get_job_file_only_agency_assigned(self):
        """Recruiter can't get Job file if his Agency assigned to a Job but he is not."""
        job = f.get_job_assigned_to_agency(self.agency)
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_get_job_file_own_not_assigned(self):
        """Recruiter can't get Job file if his Agency assigned to a Job but he is not."""
        job = f.create_job(self.agency)
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_get_job_file_own_assigned(self):
        """Recruiter can't get Job file if his Agency owns job, but he is not assigned"""
        job = f.create_job(self.agency)
        job.assign_member(self.user)
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_delete_job_file_assigned_client(self):
        """Agency Member can't delete Job file of assigned client"""
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_delete_job_file_assigned_agency(self):
        """Recruiter can delete agency job file if job is assigned to him"""
        job = f.create_job(self.agency)
        job.assign_member(self.user)
    ...
    @override_settings(MEDIA_ROOT=tempfile.gettempdir())
    def test_delete_job_file_not_assigned_agency(self):
        """Recruiter can not delete agency job file if job is not assigned to him"""
        job = f.create_job(self.agency)
        ...
        self.assert_response.not_found('delete', 'job-file-detail', job_file.pk)

    def test_assign_member_own_job(self):
        """Recruiter shouldn't be able to assign staff member to a agency own job"""
        job = f.create_job(self.agency)
    ...
    def test_assign_member_client_assigned_job(self):
        """Recruiter shouldn't be able to assign staff member to a client's job, if agency is assigned"""
        job = self.create_assigned_job()
    ...
    def test_assign_member_client_job(self):
        """Recruiter shouldn't be able to assign staff member to client's job, if agency is not assigned"""
        job = f.create_job(f.create_client())
    ...
    def test_get_agencies(self):
        """Recruiter can get the list of Agencies."""
        f.create_agency()
    ...
    def test_create_agency(self):
        """Recruiter can't create an Agency."""
    ...
    def test_get_agency_own(self):
        """Recruiter can get his own Agency details."""
    ...
    def test_get_agency_other(self):
        """Recruiter can't get other Agency details."""
    ...
    def test_update_agency_own(self):
        """Recruiter can update own Agency."""
    ...
    def test_update_agency_other(self):
        """Recruiter can't update other Agency."""
    ...
    def test_partial_update_agency_own(self):
        """Recruiter can patch own Agency."""
        data = {'name': 'New agency'}
        url = reverse('agency-detail', kwargs={'pk': self.agency.pk})
        response = self.client.patch(url, data, format='json')
    ...
    def test_partial_update_agency_other(self):
        """Recruiter can't patch other Agency."""
        agency = f.create_agency(name='Other agency')
        data = {'name': 'New agency'}
        url = reverse('agency-detail', kwargs={'pk': agency.pk})
        response = self.client.patch(url, data, format='json')
    ...
    def test_delete_agency_own(self):
        """Recruiter can't delete own Agency."""
        url = reverse('agency-detail', kwargs={'pk': self.agency.pk})
        response = self.client.delete(url)
    ...
    def test_delete_agency_other(self):
        """Recruiter can't delete other Agency."""
        agency = f.create_agency(name='Other agency')
        url = reverse('agency-detail', kwargs={'pk': agency.pk})
        response = self.client.delete(url)
    ...
    def test_get_agency_staff_list(self):
        """Recruiter can get Staff."""
        team = f.create_team(self.agency)
        recruiter = f.create_recruiter(self.agency)
        recruiter.profile.teams.add(team)
        ...
        self.assertEqual(
            {el['id'] for el in response.json()['results']},
            {
                self.user.pk,
                recruiter.pk,
                recruiter_other_team.pk,
                self.agency.primary_contact.pk,
            },
        )

    def test_get_agency_staff(self):
        """Recruiter can access the Staff detail."""
        team = f.create_team(self.agency)
        recruiter = f.create_recruiter(self.agency)
        recruiter.profile.teams.add(team)
        self.user.profile.teams.add(team)
    ...
    def test_get_agency_staff_other_agency(self):
        """Recruiter can't access the Staff from other Agency."""
    ...
    def test_update_agency_staff(self):
        """Recruiter can't update the Staff."""
    ...
    def test_update_agency_staff_other_team(self):
        """Recruiter can't update the Staff from other team."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(self.agency)
    ...
    def test_update_agency_staff_other_agency(self):
        """Recruiter can't update the Staff from other Agency."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(f.create_agency())
    ...
    def test_patch_agency_staff(self):
        """Recruiter can't patch the Staff."""
        data = {'is_active': False, 'teams': []}
        team = f.create_team(self.agency)
        recruiter = f.create_recruiter(self.agency)
        recruiter.profile.teams.add(team)
    ...
    def test_patch_agency_staff_other_team(self):
        """Recruiter can't patch the Staff from other team."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(self.agency)
        recruiter.profile.teams.set([f.create_team(self.agency)])
        recruiter.save()
    ...
    def test_patch_agency_staff_other_agency(self):
        """Recruiter can't patch the Staff from other Agency."""
        data = {'is_active': False, 'teams': []}
        recruiter = f.create_recruiter(f.create_agency())
    ...
    def test_get_agency_teams(self):
        """Recruiter can get the list of Teams."""
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual({el['id'] for el in response.json()}, {team_user_in.pk})

    # Candidate
    def test_get_candidates(self):
        """Recruiter can get Candidates only from his own Agency."""
    ...
    def test_create_candidate(self):
        """Recruiter can create a Candidate."""
        data = {
    ...
    def test_get_candidate_own_agency(self):
        """Recruiter can get the Candidate of his own Agency."""
        candidate = f.create_candidate(self.agency)
    ...
    def test_get_candidate_other_agency(self):
        """Recruiter can't get the Candidate of the other Agency."""
    ...
    def test_update_candidate_own_agency(self):
        """Recruiter can update the Candidate of his own Agency."""
    ...
    def test_update_candidate_other_agency(self):
        """Recruiter can't update the Candidate of the other Agency."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_partial_update_candidate_own_agency(self):
        """Recruiter can patch the Candidate of his own Agency."""
        candidate = f.create_candidate(
            self.agency,
            first_name='Test',
            last_name='name',
    ...
    def test_partial_update_candidate_other_agency(self):
        """Recruiter can't patch the Candidate of the other Agency."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_delete_candidate_own_agency(self):
        """Recruiter can delete the Candidate from his own Agency."""
        candidate = f.create_candidate(self.agency)
    ...
    def test_delete_candidate_other_agency(self):
        """Recruiter can't delete the Candidate from the other Agency."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_upload_file_own_candidate(self):
        """Recruiter can upload Candidate file for own Candidate."""
        candidate = f.create_candidate(self.agency)
    ...
    def test_upload_file_other_candidate(self):
        """Recruiter can't upload Candidate file for other Candidate."""
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_delete_file_own_candidate(self):
        """Recruiter can delete Candidate file for own Candidate."""
        candidate = f.create_candidate(self.agency)
        candidate.photo = SimpleUploadedFile('file.txt', b'')
        candidate.save()
    ...
    def test_delete_file_other_candidate(self):
        """Recruiter can't delete Candidate file for other Candidate."""
        candidate = f.create_candidate(f.create_agency())
        candidate.photo = SimpleUploadedFile('file.txt', b'')
        candidate.save()
    ...
    def test_get_candidate(self, get_zoho_candidate_mock):
        """Recruiter can get Zoho Candidate."""
    ...
    def test_get_proposals(self):
        """Recruiter can get Proposals linked to his own Agency only."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        ...
        agency = f.create_agency()
        f.create_proposal(job, f.create_candidate(agency), f.create_recruiter(agency))
    ...
    def test_create_proposal_not_assigned_to_client_job(self):
        """Recruiter can't create Proposal if agency assinged to a job, but he is not."""
        self.assert_response.no_permission(
            'post',
            'proposal-list',
            data={
                'job': self.create_assigned_job().pk,
                'candidate': f.create_candidate(self.agency).pk,
            },
        )

    def test_create_proposal_assigned_to_client_job(self):
        """Recruiter can create Proposal if both of him and agency were assigned to job"""
        job = f.get_job_assigned_to_agency(self.agency)
        job.assign_member(self.user)
        data = {'job': job.pk, 'candidate': f.create_candidate(self.agency).pk}
    ...
    def test_create_proposal_not_assigned_to_agency_job(self):
        """Recruiter can't create Proposal if agency owns a job, but he is not assigned."""
        self.assert_response.no_permission(
            'post',
            'proposal-list',
            data={
    ...
    def test_create_proposal_owns_but_not_assigned_to_agency_job(self):
        """Recruiter can create Proposal if he is it's owner"""
        self.assert_response.created(
            'post',
            'proposal-list',
            data={
                'job': f.create_job(self.agency, owner=self.user).pk,
                'candidate': f.create_candidate(self.agency).pk,
            },
        )

    def test_create_proposal_assigned_to_agency_job(self):
        """Recruiter can create Proposal if both of him and agency were assigned to job"""
        job = f.create_job(self.agency)
        job.assign_member(self.user)
        data = {'job': job.pk, 'candidate': f.create_candidate(self.agency).pk}
    ...
    def test_create_proposal_agency_not_assigned_to_client_job(self):
        """Recruiter can't create Proposal: own Candidate, not assigned Job."""
        self.assert_response.no_permission(
            'post',
            'proposal-list',
            data={
    ...
    def test_create_proposal_other_agency_assigned_job(self):
        """Recruiter can't create Proposal: other Candidate, assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_create_proposal_other_agency_not_assigned_job(self):
        """Recruiter can't create Proposal: o. Candidate not assigned Job."""
        job = f.create_job(f.create_client())
        candidate = f.create_candidate(f.create_agency())
    ...
    def test_get_proposal_own_agency(self):
        """Recruiter can get Proposal linked to his own Agency."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_get_proposal_other_agency(self):
        """Recruiter can't get Proposal linked to other Agency."""
    ...
    def test_update_proposal_own_agency_assigned_job(self):
        """Recruiter can't update own Agency Proposal with assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(self.agency)
    ...
    def test_update_proposal_own_agency_not_assigned_job(self):
        """Recruiter can't update own Agency Proposal with not assigned Job."""
        job = f.create_job(f.create_client())
        candidate = f.create_candidate(self.agency)
        proposal = f.create_proposal(job, candidate, self.user)
    ...
    def test_update_proposal_other_agency_assigned_job(self):
        """Recruiter can't update other Agency Proposal with assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(f.create_agency())
        proposal = f.create_proposal(job, candidate, self.user)
    ...
    def test_update_proposal_other_agency_not_assigned_job(self):
        """Recruiter can't upd other Agency Proposal with not assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        candidate = f.create_candidate(f.create_agency())
        proposal = f.create_proposal(job, candidate, self.user)
    ...
    def test_partial_update_proposal_own_agency_assigned_job(self):
        """Recruiter can't patch own Agency Proposal with assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        job.assign_member(self.user)
        proposal = f.create_proposal(job, f.create_candidate(self.agency), self.user)
    ...
    def test_partial_update_proposal_own_agency_not_assigned_job(self):
        """Recruiter can't patch own Agency Proposal not assigned Job."""
        proposal = f.create_proposal(
    ...
    def test_partial_update_proposal_own_agency_own_job(self):
        """Recruiter can patch own Agency Proposal assigned Job."""
        job = f.create_job(self.agency)
        job.assign_member(self.user)
        proposal = f.create_proposal(job, f.create_candidate(self.agency), self.user,)
    ...
    def test_partial_update_proposal_other_agency_assigned_job(self):
        """Recruiter can't patch other Agency Proposal assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        proposal = f.create_proposal(
    ...
    def test_partial_update_proposal_other_agency_not_assigned_job(self):
        """Recruiter can't patch other Agency Proposal, not assigned Job."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()),
            f.create_candidate(f.create_agency()),
            self.user,
    ...
    def test_delete_proposal_own_agency_assigned_job(self):
        """Recruiter can't delete own Agency Proposal with assigned Job."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_delete_proposal_own_agency_not_assigned_job(self):
        """Recruiter can't delete own Agency Proposal with not assigned Job."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_delete_proposal_other_agency_assigned_job(self):
        """Recruiter can't delete other Agency Proposal with assigned Job."""
        job = f.create_job(f.create_client())
        job.assign_agency(self.agency)
        proposal = f.create_proposal(
            job, f.create_candidate(f.create_agency()), self.user
    ...
    def test_delete_proposal_other_agency_not_assigned_job(self):
        """Recruiter can't delete other Agency Proposal, not assigned Job."""
        proposal = f.create_proposal(
            f.create_job(f.create_client()),
            f.create_candidate(f.create_agency()),
            self.user,
    ...
    def test_get_proposal_comments(self):
        """Recruiter can get the list of Proposal comments."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_create_proposal_comment_own_proposal(self):
        """Recruiter can create Proposal Comment for own Proposal."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_create_proposal_comment_own_agency_proposal(self):
        """Recruiter can create Comment for Proposal from own Agency."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_create_proposal_comment_other_proposal(self):
        """Recruiter can't create Comment for other Agency's Proposal."""
    ...
    def test_get_proposal_comment_own(self):
        """Recruiter can get own Proposal Comment details."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_get_proposal_comment_user_own_agency(self):
        """Recruiter can get own Agency User's Proposal Comment."""
        client = f.create_client()
        f.create_contract(self.agency, client)
        job = f.create_job(client)
        job.assign_agency(self.agency)
    ...
    def test_get_proposal_comment_other_agency(self):
        """Recruiter can't get Proposal Comment of other Agency."""
    ...
    def test_get_proposal_comment_other_agency_public(self):
        """Recruiter can't get public Comment of other Agency."""
        agency_other = f.create_agency()
        recruiter = f.create_recruiter(agency_other)
    ...
    def test_get_proposal_comment_client(self):
        """Recruiter can't get Client's Proposal Comment."""
        client = f.create_client()
    ...
    def test_get_proposal_comment_client_public(self):
        """Recruiter can get Client's public Proposal Comment."""
        client = f.create_client()
        client_admin = f.create_client_administrator(client)
        f.create_contract(self.agency, client)
        job = f.create_job(client)
    ...
    def test_mark_all_as_read(self):
        """Recruiter User can mark all Notifications as read."""
    ...
    def test_mark_as_read(self):
        """Recruiter User can mark own Notification as read."""
    ...
    def test_mark_as_read_other_user(self):
        """Recruiter User can't mark other User Notification as read."""
        notification = f.create_notification(
            f.create_user(),
            verb=m.NotificationTypeEnum.CLIENT_CREATED_CONTRACT,
            actor=f.create_agency(),
    ...
    def test_get_contracts(self):
        """Recruiter can get Contracts linked to his own Agency only."""
        client = f.create_client()
    ...
    def test_create_contract_own_agency(self):
        """Recruiter can't create a Contract for his own Agency."""
    ...
    def test_create_contract_other_agency(self):
        """Recruiter can't create a Contract for the other Agency."""
    ...
    def test_get_contract_own_agency(self):
        """Recruiter can get Contract linked to his own Agency."""
    ...
    def test_get_contract_other_agency(self):
        """Recruiter can't get Contract linked to other Agency."""
    ...
    def test_update_contract_own_agency(self):
        """Recruiter can't update the Contract of his own Agency."""
        contract = f.create_contract(self.agency, f.create_client())
    ...
    def test_update_contract_other_agency(self):
        """Recruiter can't update the Contract of the other Agency."""
        agency = f.create_agency()
    ...
    def test_partial_update_contract_own_agency(self):
        """Recruiter can't patch the Contract of his own Agency."""
        contract = f.create_contract(self.agency, f.create_client())
    ...
    def test_partial_update_contract_other_agency(self):
        """Recruiter can't patch the Contract of the other Agency."""
        agency = f.create_agency()
        contract = f.create_contract(agency, f.create_client())
    ...
    def test_delete_contract_own_agency(self):
        """Recruiter can't delete the Contract of his own Agency."""
        contract = f.create_contract(self.agency, f.create_client())
    ...
    def test_delete_contract_other_agency(self):
        """Recruiter can't delete the Contract of the other Agency."""
        contract = f.create_contract(f.create_agency(), f.create_client())
    ...
    def test_get_user(self):
        """Recruiter can get his own User detail."""
    ...
    def test_change_password(self):
        """Recruiter can update his own User password."""
        data = {
    ...
    def test_confirm_password_reset(self):
        """Recruiter can confirm password reset with the correct token."""
    ...
    def test_login(self):
        """Recruiter can log into another account."""
        other_user = f.create_recruiter(self.agency, 'otheruser@test.com', 'password')
    ...
    def test_reset_password(self):
        """Recruiter can request a password reset."""
    ...
    def test_update_settings(self):
        """Recruiter can update hist own User settings."""
    ...
    def test_proposal_move_to_job(self):
        ...
        another_job = f.get_job_assigned_to_agency(self.agency, client)

        job.assign_member(self.user)
        another_job.assign_member(self.user)
    ...
    def test_proposal_move_to_job_not_assigned(self):
        """Should not move proposal to other job."""
        client = f.create_client()

        job = self.create_assigned_job(client)

        proposal = f.create_proposal(
            job, f.create_candidate(self.agency), f.create_recruiter(self.agency)
        )

        another_job = self.create_assigned_job(client)
    ...
    def test_get_deal_pipeline_metrics(self):
        """Recruiter has access to the deal pipeline metrics"""
    ...
    def test_job_import_longlist(self, import_longlist_mock):
        """Recruiter can't import longlist"""
        job = f.create_job(self.agency)
        data = {
            'from_job': job.pk,
            'candidates': [],
        }
        self.assert_response.no_permission('post', 'job-import-longlist', job.pk, data)
...
class TestProposalInterviewViewSet(APITestCase):
    def setUp(self):
        ...
        agency_job.assign_member(self.user)
        self.proposal_agency_job = f.create_proposal_with_candidate(
            agency_job, self.user
        )
        self.proposal_2_agency_job = f.create_proposal_with_candidate(
            agency_job, self.user,
        )
    ...
    def test_update_mine_agency_job(self):
        ...
        self.assert_response.ok(
            ...
            'proposal_interviews-detail',
            interview.pk,
            self.get_create_update_request_data(self.proposal_2_agency_job),
        )

    def test_update_other_member_agency_job(self):
        interview = f.create_proposal_interview(self.proposal_agency_job, self.user)
