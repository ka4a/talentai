...
const usePages = ({
  ...
  if (lastPageOfLeftMargin >= 1) {
    pages.push(..._.range(1, lastPageOfLeftMargin + 1));
  }
  ...
  if (lastPageOfMiddleRange >= firstPageOfMiddleRange) {
    pages.push(..._.range(firstPageOfMiddleRange, lastPageOfMiddleRange + 1));
  }
  ...
  if (maxPage >= firstPageOfRightMargin) {
    pages.push(..._.range(firstPageOfRightMargin, maxPage + 1));
  }
